...
public class CuttingRecordJpaEntity {
    ...
    CuttingRecordJpaEntity(Long inventoryItemId, Long machineId, Long operatorId, Long shiftId,
                           int initialQuantity, int goodQuantity, int scrapQuantity) {
    ...
    @PrePersist
    void onCreate() {
        cutAt = LocalDateTime.now();
    }

    Long getId() { return id; }
    Long getInventoryItemId() { return inventoryItemId; }
    ...
    int getScrapQuantity() { return scrapQuantity; }
    LocalDateTime getCutAt() { return cutAt; }
}